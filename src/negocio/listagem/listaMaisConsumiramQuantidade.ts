...
export default class listagemMaisConsumiramQuantidade extends Listagem {
    ...
    public listar(): void {
        ...
        console.log(`--------------------------------------`);
        console.log(`Lista dos 10 clientes que mais consumiram produtos e serviços em quantidade`);
